...
$mail->Username = 'YOUR-EmailID@host.com';          // SMTP username
$mail->Password = 'YOUR-PASSWORD'; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to

$mail->setFrom('Your-EmailID@host.com', 'Admin');
$mail->addReplyTo('Your-EmailID@host.com', 'Admin');
...
$mail->Subject = 'Email from Shobhit Notes ';
